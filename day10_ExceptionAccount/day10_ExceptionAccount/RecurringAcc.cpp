...
float RecurringAcc::int_rate = 7.5f;
...
RecurringAcc::RecurringAcc(int accno, const char* name, float balance, double instAmt, int noOfInst)
...
float RecurringAcc::cal_NetBalance() {
    float total = instAmt * noOfInst;
    float interest = (total * int_rate) / 100;
